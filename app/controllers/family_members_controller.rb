class FamilyMembersController < ApplicationController
  ...
  private
    ...
    def family_member_params
      params.require(:family_member).permit(:first_name, :last_name, :contact, :birth_date, :gender, :flat_id, :pan_card_number, :adhaar_card_number, :avatar_url, :maritial_status, :status, :relation_with)
    end
end
